...
//    {0xA306,QSTR("车载应答器天线严重故障"),                                QSTR("车载应答器天线严重故障")},
    ...
    {0xD326, QSTR("弓网监测设备2号相机异常"), QSTR("检修弓网检测设备")},
    {0xD336, QSTR("弓网监测设备3号相机异常"), QSTR("检修弓网检测设备")},
    {0xD346, QSTR("弓网监测设备4号相机异常"), QSTR("检修弓网检测设备")},
    {0xD356, QSTR("弓网监测设备5号相机异常"), QSTR("检修弓网检测设备")},
    {0xD366, QSTR("弓网监测设备6号相机异常"), QSTR("检修弓网检测设备")},
    {0xD376, QSTR("弓网监测设备7号相机异常"), QSTR("检修弓网检测设备")},
    {0xD386, QSTR("弓网监测设备8号相机异常"), QSTR("检修弓网检测设备")},
...
//    {0x9308,  3,  D_POS_F, 151,   bit8,   false,  false, false,  E_FAULTS_CATEGORY_PIS    },
    ...
    {0xD102, 2, D_POS_B, 4020, bit1, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD103, 2, D_POS_B, 4020, bit2, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD201, 2, D_POS_B, 4020, bit3, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD301, 2, D_POS_B, 4020, bit4, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD302, 2, D_POS_B, 4020, bit5, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD303, 2, D_POS_B, 4020, bit6, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD304, 2, D_POS_B, 4020, bit7, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD305, 2, D_POS_B, 4020, bit8, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD316, 2, D_POS_B, 4020, bit9, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD326, 2, D_POS_B, 4020, bit10, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD336, 2, D_POS_B, 4020, bit11, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD346, 2, D_POS_B, 4020, bit12, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD356, 2, D_POS_B, 4020, bit13, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD366, 2, D_POS_B, 4020, bit14, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD376, 2, D_POS_B, 4020, bit15, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD386, 2, D_POS_B, 4021, bit0, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD307, 2, D_POS_B, 4021, bit1, false, false, false, E_FAULTS_CATEGORY_PMS},
    {0xD308, 2, D_POS_B, 4021, bit2, false, false, false, E_FAULTS_CATEGORY_PMS},
